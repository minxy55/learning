 ...
 */
/* $begin rio_read */
ssize_t rio_readb(rio_t *rp, char *usrbuf, size_t n)
{
    int cnt;
 ...
 **********************************/
ssize_t Rio_read(int fd, void *ptr, size_t nbytes)
{
    ssize_t n;
...
ssize_t Rio_readb(rio_t *rp, void *usrbuf, size_t n)
{
    ...
    if ((rc = rio_readb(rp, usrbuf, n)) < 0)
		unix_error("Rio_readb error");
    return rc;
}
...
int Set_nonblocking(int sock)
{
    ...
    {
        unix_error("fcntl(sock, SETFL, opts)");
        return opt;
    }
}
/* $end csapp.c */
